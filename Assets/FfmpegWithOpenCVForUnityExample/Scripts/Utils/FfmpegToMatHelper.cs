...
namespace FfmpegWithOpenCVForUnity.UnityUtils.Helper
{
    ...
    public class FfmpegToMatHelper : MonoBehaviour
    {
        ...
        protected int _timeoutFrameCount = 500;
        ...
        protected System.Object baseMatLockObject = new System.Object();
        protected Mat _baseMat;
        protected Mat baseMat
        {
            get { lock (baseMatLockObject) return _baseMat; }
            set { lock (baseMatLockObject) _baseMat = value; }
        }
        ...
        protected virtual IEnumerator _Initialize()
        {
            ...
            if (readCommand.VideoTextures.Length < 1 || readCommand.VideoTextures[0] == null)
            {
                ...
                if (onErrorOccurred != null)
                    onErrorOccurred.Invoke(ErrorCode.VIDEOTEXTURE_NOT_SET);
            ...
            while (!readCommand.WriteNextTexture() && !readCommand.IsEOF && readCommand.IsRunning)
            {
                if (initFrameCount > timeoutFrameCount)
                {
                    isTimeout = true;
        ...
        public virtual void Play()
        {
            ...
            //{
                ...
                //readCommand.SetTime(0);

                //Debug.Log("Play() hasInitDone");
        ...
        public virtual FfmpegPlayerVideoTexture GetFfmpegPlayerVideoTexture()
        {
            return hasInitDone ? readCommand.VideoTextures[0] : null;
        }
